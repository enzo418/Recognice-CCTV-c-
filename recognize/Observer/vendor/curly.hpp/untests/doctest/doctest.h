...
namespace doctest {
    ...
    struct ContextOptions  //! OCLINT too many fields
    {
        ...
        bool force_colors;  // forces the use of colors even when a tty cannot
                            // be detected
        bool no_breaks;     // to not break into the debugger
        bool no_skip;  // don't skip test cases which are marked to be skipped
        bool gnu_file_line;  // if line numbers should be surrounded with :x:
                             // and not (x):
...
#define DOCTEST_BINARY_RELATIONAL_OP(n, op) \
    template <class L, class R> struct RelationalComparator<n, L, R> { bool operator()(const DOCTEST_REF_WRAP(L) lhs, const DOCTEST_REF_WRAP(R) rhs) const { return op(lhs, rhs); } };
        ...
        DOCTEST_INTERFACE void failed_out_of_a_testing_context(
            const AssertData& ad);
...
#define DOCTEST_ASSERT_IN_TESTS(decomp)                                    \
    ...
    if (rb.m_failed && checkIfShouldThrow(at)) throwException()
        ...
        DOCTEST_NOINLINE void unary_assert(assertType::Enum at,
            ...
            if (at & assertType::is_false)  //! OCLINT bitwise operator in
                                            //! conditional
                failed = !failed;
        ...
        class ExceptionTranslator
            : public IExceptionTranslator  //! OCLINT destructor of virtual
                                           //! class
        {
           public:
        ...
        if (!doctest::getContextOptions()->no_throw) {                       \
            ...
            try {                                                            \
                DOCTEST_CAST_TO_VOID(expr)                                   \
                     ...
                     doctest::detail::remove_reference<__VA_ARGS__>::type>:: \
                         type&) {                                            \
                _DOCTEST_RB.translateException();                            \
...
#define DOCTEST_CHECK_THROWS_WITH_MESSAGE(expr, with, msg) \
    (static_cast<void>(0))
#define DOCTEST_REQUIRE_THROWS_WITH_MESSAGE(expr, with, msg) \
    (static_cast<void>(0))
#define DOCTEST_WARN_THROWS_WITH_AS_MESSAGE(expr, with, ex, msg) \
    (static_cast<void>(0))
#define DOCTEST_CHECK_THROWS_WITH_AS_MESSAGE(expr, with, ex, msg) \
    (static_cast<void>(0))
#define DOCTEST_REQUIRE_THROWS_WITH_AS_MESSAGE(expr, with, ex, msg) \
    (static_cast<void>(0))
...
namespace doctest {
    ...
    namespace detail {
        ...
        DOCTEST_THREAD_LOCAL std::ostringstream
        ...
        // tests
        struct ContextState : ContextOptions,
                              TestRunStats,
...
const char* assertString(assertType::Enum at) {
    ...
    const char* failureString(assertType::Enum at) {
        if (at & assertType::is_warn)  //! OCLINT bitwise operator in
                                       //! conditional
            return "WARNING";
        if (at &
...
#define DOCTEST_ITERATE_THROUGH_REPORTERS(function, ...)  \
    ...
    namespace {
        ...
        void color_to_stream(std::ostream& s, Color::Enum code) {
            static_cast<void>(s);     // for DOCTEST_CONFIG_COLORS_NONE or
...
// clang-format on
    ...
    namespace detail {
        ...
        // See the comments in Catch2 for the reasoning behind this
        // implementation:
...
#define DOCTEST_OUTPUT_DEBUG_STRING( \
    ...
    namespace detail {
        ...
        bool ResultBuilder::log() {
            if (m_at & assertType::is_throws) {  //! OCLINT bitwise operator in
                ...
                m_failed = !m_threw_as || (m_exception != m_exception_string);
                       ...
                       assertType::is_throws_as) {  //! OCLINT bitwise operator
                                                    //! in conditional
                m_failed = !m_threw_as;
            } else if (m_at &
                       assertType::is_throws_with) {  //! OCLINT bitwise
                                                      //! operator in conditional
                m_failed = m_exception != m_exception_string;
            } else if (m_at &
                       assertType::is_nothrow) {  //! OCLINT bitwise operator in
                                                  //! conditional
                m_failed = m_threw;
            }
        ...
        void MessageBuilder::react() {
            if (m_severity & assertType::is_require)  //! OCLINT bitwise
                                                      //! operator in conditional
                throwException();
        }
...
// =================================================================================================
        ...
        struct XmlReporter : public IReporter {
            ...
            void test_run_end(const TestRunStats& p) override {
                if (tc)  // the TestSuite tag - only if there has been at least
                         // 1 test case
                    xml.endElement();
        ...
        void fulltext_log_assert_to_stream(std::ostream& s,
            ...
            if (rb.m_at & assertType::is_throws) {  //! OCLINT bitwise operator
                                                    //! in conditional
        ...
        struct JUnitReporter : public IReporter {
            ...
            struct JUnitTestCaseData {
                ...
                void appendSubcaseNamesToLastTestcase(
            ...
            void log_assert(const AssertData& rb) override {
                if (!rb.m_failed)  // report only failures & ignore the
                                   // `success` option
                    return;
        ...
        struct ConsoleReporter : public IReporter {
            ...
            Color::Enum getSuccessOrFailColor(bool success,
                                              assertType::Enum at) {
            ...
            void test_run_end(const TestRunStats& p) override {
                ...
                auto totwidth = int(std::ceil(
                    log10((std::max(p.numTestCasesPassingFilters,
    ...
    void func(type arg) override {                              \
        ...
        bool parseOptionImpl(int argc, const char* const* argv,
            ...
            for (int i = argc; i > 0; --i) {
                ...
                if (temp &&
                    (value || strlen(temp) ==
                                  strlen(pattern))) {  //! OCLINT prefer early
                                                       //! exits and continue
