 ...
 *
 * In order to avoid circular implementation you shoud always check that all the
 * files from implementation don't include the current file! Usually this is the
 * case of the interfaces since an implementation implements an interface.
 *
